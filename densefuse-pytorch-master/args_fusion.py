...
class args():
	...
	# dataset = "MSCOCO"
	dataset = ["images/train/VIS", "images/train/INF"]
	# dataset1 = "VIS"
	# dataset2 = "INF"
	...
	"""调整测试模型"""
	# model_path_rgb = "./models/1e2/Final_epoch_4_Tue_Dec_20_15_54_17_2022_1e2.model"
	# model_path_gray = "./models/1e2/Final_epoch_4_Tue_Dec_20_15_54_32_2022_1e2.model"
